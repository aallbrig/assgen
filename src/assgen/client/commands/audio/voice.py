...
def voice_tts(
    ...
    emotion: str | None = typer.Option(
        None, "--emotion", help="Emotion tag: neutral angry happy sad fearful"
    ),
    speaker: str | None = typer.Option(
        None, "--speaker", help="Speaker preset, e.g. 'v2/en_speaker_6'"
    ),
...
def voice_dialog(
    ...
    output_dir: str | None = typer.Option(
        None, "--output-dir", "-o", help="Directory for output files"
    ),
    wait: bool | None = _WAIT_OPT,
) -> None:
