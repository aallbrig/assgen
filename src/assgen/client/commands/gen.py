...
.. code-block:: text
    ...
    assgen gen audio music compose       — music from text
...
app = typer.Typer(
    ...
    help=(
        ...
        "[bold]pipeline[/bold] · [bold]support[/bold] · [bold]qa[/bold]\n\n"
...
app.add_typer(pipeline_app, name="pipeline", help="Workflows, batching, engine integration")
