...
app = typer.Typer(
    help="Asset validation, performance testing, and QA reporting.", no_args_is_help=True
)
...
def qa_style(
    ...
    style_guide: str | None = typer.Option(
        None, "--guide", help="Path to style guide image or YAML"
    ),
