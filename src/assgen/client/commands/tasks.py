...
_TASK_DESC: dict[str, str] = {
    ...
    "visual.ui.layout": "Grid-based HUD and menu layout compositions",
    "visual.ui.iconset": "Themed icon pack with style consistency across all icons",
    "visual.ui.theme": "Coordinated UI theme kit (icons + buttons + panels) from a style reference",
    "visual.ui.screen": "Complete game screen composition at full resolution",
    # audio / sfx
...
_DOMAIN_TREE: dict[str, dict] = {
    "visual": {
        "_icon": "🎨",
        "_desc": "3D visual asset creation",
        "concept": {
            "_icon": "💡",
            "_desc": "Concept art & style references",
            "_tasks": ["generate", "ref", "style"],
        },
        "blockout": {
            "_icon": "📦",
            "_desc": "Rapid greybox / prototype",
            "_tasks": ["create", "assemble", "iterate"],
        },
        "model": {
            "_icon": "🔷",
            "_desc": "3D mesh generation & editing",
            "_tasks": ["create", "retopo", "splat", "edit", "multiview"],
        },
        "mesh": {
            "_icon": "🔩",
            "_desc": "Mesh processing (algorithmic)",
            "_tasks": [
                "validate",
                "convert",
                "merge",
        ...
        "lod": {"_icon": "📉", "_desc": "Level of Detail generation", "_tasks": ["generate"]},
        "uv": {
            "_icon": "🗺",
            "_desc": "UV unwrapping & layout",
            "_tasks": ["auto", "manual", "optimize"],
        },
        "texture": {
            "_icon": "🖼",
            "_desc": "PBR textures, baking, materials",
            "_tasks": [
                "generate",
                "apply",
                "bake",
        ...
        "sprite": {"_icon": "🎞", "_desc": "Sprite sheet packing", "_tasks": ["pack"]},
        "rig": {
            "_icon": "🦴",
            "_desc": "Rigging & skinning",
            "_tasks": ["auto", "skin", "retarget"],
        },
        "animate": {
            "_icon": "🎬",
            "_desc": "Animation generation",
            "_tasks": ["keyframe", "mocap", "blend", "retarget"],
        },
        "vfx": {
            "_icon": "✨",
            "_desc": "Particles, decals, simulations",
            "_tasks": ["particle", "decal", "sim"],
        },
        "ui": {
            "_icon": "🖥",
            "_desc": "Icons, HUD, 2D overlays, and UI components",
            "_tasks": [
                "icon",
                "hud",
                "overlay",
    ...
    "audio": {
        "_icon": "🔊",
        "_desc": "Sound effects, music, voice synthesis",
        "sfx": {"_icon": "💥", "_desc": "Sound effects", "_tasks": ["generate", "edit", "library"]},
        "music": {
            "_icon": "🎵",
            "_desc": "Music and adaptive tracks",
            "_tasks": ["compose", "loop", "adaptive"],
        },
        "ambient": {
            "_icon": "🌊",
            "_desc": "Ambient soundscapes and loops",
            "_tasks": ["generate"],
        },
        "voice": {"_icon": "🗣", "_desc": "Dialog and voice", "_tasks": ["tts", "clone", "dialog"]},
        "process": {
            "_icon": "🔧",
            "_desc": "Algorithmic audio processing",
            "_tasks": [
                "normalize",
                "trim_silence",
                "loop_optimize",
    ...
    "scene": {
        "_icon": "🌍",
        "_desc": "Physics data & environment lighting",
        "physics": {
            "_icon": "⚡",
            "_desc": "Collision & simulation data",
            "_tasks": ["collider", "rigid", "cloth"],
        },
        "lighting": {
            "_icon": "💡",
            "_desc": "Lighting & render environment",
            "_tasks": ["hdri", "probes", "volumetrics", "bake"],
        },
        "depth": {"_icon": "📐", "_desc": "Depth estimation from images", "_tasks": ["estimate"]},
    },
    "pipeline": {
        "_icon": "⚙️",
        "_desc": "Workflows, batching, engine integration, asset tools",
        "workflow": {
            "_icon": "🔗",
            "_desc": "Multi-step job chains",
            "_tasks": ["create", "run", "list"],
        },
        "batch": {
            "_icon": "📋",
            "_desc": "Bulk job processing",
            "_tasks": ["queue", "variant", "status"],
        },
        "integrate": {
            "_icon": "🚀",
            "_desc": "Engine packaging & export",
            "_tasks": ["prefab", "export", "script"],
        },
        "asset": {
            "_icon": "📁",
            "_desc": "Asset manifest, validation, rename, budget",
            "_tasks": ["manifest", "validate", "rename", "report"],
        },
        "git": {"_icon": "🔀", "_desc": "Git / VCS helpers", "_tasks": ["lfs_rules"]},
    },
    "procedural": {
        "_icon": "🎲",
        "_desc": "Procedural generation (no ML)",
        "terrain": {
            "_icon": "🏔",
            "_desc": "Procedural terrain heightmaps",
            "_tasks": ["heightmap"],
        },
        "texture": {"_icon": "🔲", "_desc": "Procedural noise textures", "_tasks": ["noise"]},
        "level": {
            "_icon": "🗺",
            "_desc": "Procedural level layouts",
            "_tasks": ["dungeon", "voronoi"],
        },
        "foliage": {
            "_icon": "🌿",
            "_desc": "Foliage scatter from density maps",
            "_tasks": ["scatter"],
        },
        "tileset": {"_icon": "🧩", "_desc": "Wave Function Collapse tilesets", "_tasks": ["wfc"]},
        "plant": {"_icon": "🌱", "_desc": "L-system plant skeletons", "_tasks": ["lsystem"]},
    },
    "support": {
        "_icon": "📝",
        "_desc": "Narrative, lore, procedural data",
        "narrative": {
            "_icon": "📖",
            "_desc": "Story & lore generation",
            "_tasks": ["dialog", "lore"],
        },
        "data": {"_icon": "📊", "_desc": "Baked & procedural data", "_tasks": ["lightmap", "proc"]},
    },
    "narrative": {
        "_icon": "📖",
        "_desc": "NPC dialogue, lore, and quest design (LLM + algorithmic)",
        "dialogue": {
            "_icon": "💬",
            "_desc": "NPC dialog generation & validation",
            "_tasks": ["npc", "validate"],
        },
        "lore": {"_icon": "📜", "_desc": "World-building lore text", "_tasks": ["generate"]},
        "quest": {
            "_icon": "⚔️",
            "_desc": "Quest and mission design",
            "_tasks": ["design", "validate"],
        },
        "i18n": {
            "_icon": "🌐",
            "_desc": "Internationalisation string extraction",
            "_tasks": ["extract"],
        },
    },
    "qa": {
        "_icon": "✅",
        "_desc": "Asset validation & performance testing",
...
def _build_tree(domain_filter: str | None = None) -> Tree:
    ...
    for domain in domains:
        ...
        for key, val in dspec.items():
            ...
            sub_node = domain_node.add(f"{sub_icon} [bold]{key}[/bold]  [dim]{sub_desc}[/dim]")
...
def _add_task_leaf(
    ...
    parent_node.add(f"[cyan]{action}[/cyan]  {model_label}\n  [dim]{desc}[/dim]")
